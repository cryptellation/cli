// A generated module for Cli functions
//
...
import (
	...
	"github.com/cryptellation/cli/dagger/internal/dagger"
)

type Cli struct{}

// Publish a new release.
func (ci *Cli) PublishTag(
	ctx context.Context,
...
func (ci *Cli) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (ci *Cli) LintDagger(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
		From("golangci/golangci-lint:v1.62.0").
		WithMountedCache("/root/.cache/golangci-lint", dag.CacheVolume("golangci-lint"))
...
func (ci *Cli) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (ci *Cli) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
	containerPath := "/go/src/github.com/cryptellation/cli"
	return c.
		// Add Go caches
