...
func (mod *Cli) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (mod *Cli) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (mod *Cli) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
